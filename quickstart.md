...
These workflows will be updated on a regular basis so check for the latest version <a href="https://github.com/terrimporter/MetaWorks/releases"  target="_blank">here</a>. Note that the OTU, global ESV, & global OTU pipelines above are new and have only been tested with the 16S and ITS markers.
